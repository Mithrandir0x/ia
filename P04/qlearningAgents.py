...
class QLearningAgent(ReinforcementAgent):
  ...
  def __init__(self, **args):
    ...
    self.Q = util.Counter()
    # Modify this value to set how many actions to choose
    # randomly before selecting greedily
  ...
  def getAction(self, state):
    ...
    if actions:
      ...
      #if self.to_greedy < self.greedy_constraint:
        #self.to_greedy += 1
...
class ApproximateQAgent(PacmanQAgent):
  ...
  def final(self, state):
    ...
    if self.episodesSoFar == self.numTraining:
      ...
      # - You know, I might want to print them wherever I wish so...
      # you don't have to be so angsty
      # - ¬¬
      # whatever man, you're just talking to yourself, and this is getting boring
      pass
